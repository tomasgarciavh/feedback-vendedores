...
_QUIZZES = {
    3: {
        "modulo": 3, "emoji": "🧠",
        "titulo": "Sistema de Ventas Humanas",
        "aprobado": 13, "volver": 12,
        "preguntas": [
            {"pregunta": "¿Cuál es la parte más IMPORTANTE de la estructura de Ventas Humanas?",
             "opciones": ["El Pitch personalizado", "El Diagnóstico", "El inicio y final de la reunión", "El Descubrimiento"],
             "correcta": 3, "explicacion": "El Descubrimiento es la base de todo. Sin él, el resto del proceso pierde sentido."},
            {"pregunta": "¿Cuál es el objetivo principal del DESCUBRIMIENTO?",
             "opciones": ["Convencer al prospecto de comprar", "Mostrar autoridad y conocimiento", "Entender la situación, problemas, dolores y el deseo real", "Presentar el producto de forma personalizada"],
             "correcta": 2, "explicacion": "Descubrir es escuchar y entender profundamente al lead antes de ofrecer cualquier solución."},
            {"pregunta": "¿Cuál de las siguientes NO es un acuerdo que debemos lograr en el DESCUBRIMIENTO?",
             "opciones": ["Que existe un problema que podés ayudar a resolver", "Cuánto le cuesta tener ese problema", "Por qué no puede resolverlo solo", "Pedirle permiso para hacer el pitch"],
             "correcta": 3, "explicacion": "El permiso para el pitch es la etapa PERMISO, posterior al descubrimiento y diagnóstico."},
            {"pregunta": "¿Es necesario ANCLAR emociones a los problemas y objetivos del prospecto?",
             "opciones": ["Sí, aumenta la probabilidad de compra", "No es necesario, puede comprar igual"],
             "correcta": 0, "explicacion": "Anclar emociones conecta los dolores con consecuencias reales, generando urgencia genuina."},
            {"pregunta": "El prospecto te dice que tiene problemas de ventas en su negocio. ¿Es suficiente para avanzar?",
             "opciones": ["Sí, ya tengo su problema principal", "No, es necesario profundizar y encontrar qué le genera ese problema"],
             "correcta": 1, "explicacion": "Siempre hay que profundizar. ¿Qué consecuencias tiene ese problema? ¿Cuánto le cuesta? ¿Hace cuánto lo tiene?"},
            {"pregunta": "Lo MÁS IMPORTANTE del PITCH para que sea perfecto y personalizado es:",
             "opciones": ["Poder unir los pasos del producto al caso particular del lead", "Que el cliente se sintió importante", "Que generé emociones de compra", "Que pedí permiso antes"],
             "correcta": 0, "explicacion": "Un pitch personalizado conecta cada aspecto de tu solución con los dolores específicos que descubriste."},
            {"pregunta": "¿Cuándo aparece la MAYORÍA de las objeciones?",
             "opciones": ["Cuando el pitch es largo", "Es normal que siempre surjan", "Cuando tuve un descubrimiento pobre", "Cuando el producto es más caro de lo que el lead esperaba"],
             "correcta": 2, "explicacion": "Las objeciones son síntomas de un mal descubrimiento. Si conocés bien al lead, las objeciones casi no existen."},
            {"pregunta": "Estás hablando con un prospecto y todavía no entendés bien su situación. ¿Qué hacés?",
             "opciones": ["Avanzás con el pitch para no perder tiempo", "Intentás ver si es un lead calificado", "Profundizás con preguntas abiertas", "Le explicás cómo podés ayudarlo"],
             "correcta": 2, "explicacion": "Nunca avancés sin entender. Las preguntas abiertas son tu mejor herramienta de descubrimiento."},
            {"pregunta": "Las objeciones se pueden ELIMINAR:",
             "opciones": ["Haciendo un mejor descubrimiento", "Respondiendo bien después del pitch", "En una etapa de seguimiento posterior"],
             "correcta": 0, "explicacion": "Si el descubrimiento es profundo y el diagnóstico es preciso, las objeciones se disuelven antes de aparecer."},
            {"pregunta": "¿Cómo resolvés la objeción: 'La semana que viene tengo otra reunión igual, ahí decido'?",
             "opciones": ["Previamente en el descubrimiento con preguntas específicas", "Solo cuando aparece la objeción, después de dar el precio"],
             "correcta": 0, "explicacion": "Esta objeción se previene descubriendo en qué criterio basa su decisión y por qué tu solución es diferente."},
            {"pregunta": "En una venta humana, ¿es importante justificar siempre el precio con valor?",
             "opciones": ["Verdadero", "Falso"],
             "correcta": 0, "explicacion": "Siempre debés conectar el precio con el valor percibido y el costo de NO resolver el problema."},
            {"pregunta": "Utilizar el mismo lenguaje verbal que el prospecto es:",
             "opciones": ["Importante para generar familiaridad o confianza subconsciente", "No cambia demasiado, da igual"],
             "correcta": 0, "explicacion": "El cerebro reconoce el espejo lingüístico y lo interpreta como cercanía y comprensión genuina."},
            {"pregunta": "¿Cuál es la SECUENCIA correcta del proceso de Ventas Humanas?",
             "opciones": ["Descubrimiento → Diagnóstico → Permiso → Pitch", "Pitch → Descubrimiento → Diagnóstico → Permiso", "Diagnóstico → Descubrimiento → Pitch → Permiso", "Permiso → Diagnóstico → Descubrimiento → Pitch"],
             "correcta": 0, "explicacion": "Descubrimiento → Diagnóstico → Permiso → Pitch. Cada etapa prepara la siguiente."},
            {"pregunta": "Cuando el prospecto objeta el precio, lo más probable es que:",
             "opciones": ["El precio sea demasiado alto", "Hubo un descubrimiento o diagnóstico pobre", "El producto no sea bueno", "El vendedor no fue claro en la presentación"],
             "correcta": 1, "explicacion": "Si el lead no percibe el valor, es porque no se descubrió bien su problema ni su costo real."},
            {"pregunta": "¿En qué momento pedís PERMISO para hacer el pitch?",
             "opciones": ["Al inicio de la reunión, antes de conocer al lead", "Después de completar el descubrimiento y el diagnóstico", "Cuando el cliente pregunta por el precio", "Al final cuando ya no hay más que decir"],
             "correcta": 1, "explicacion": "El permiso viene después de que el lead reconoció su problema y acordaste que podés ayudarlo. Recién ahí tiene sentido el pitch."},
        ]
    },
    4: {
        "modulo": 4, "emoji": "🔬",
        "titulo": "Psicología en Ventas y Neuroventas",
        "aprobado": 9, "volver": 8,
        "preguntas": [
            {"pregunta": "En la toma de decisiones, la parte 'Lógica' es importante porque:",
             "opciones": ["Es la menos importante de todas", "Necesitamos justificar con lógica nuestra compra emocional", "Determina la compra en la mayoría de los casos"],
             "correcta": 1, "explicacion": "Las decisiones son emocionales. La lógica llega después para justificar lo que ya decidimos emocionalmente."},
            {"pregunta": "¿Cuál es la estructura correcta para contar una historia de ventas?",
             "opciones": ["Problema → Solución → Resultado", "Personaje → Problema → Mentor → Plan → Acción → Éxito/Tragedia", "Solo el éxito final importa para convencer", "Éxito → Problema → Solución"],
             "correcta": 1, "explicacion": "Esta estructura (inspirada en el Viaje del Héroe) activa el cerebro emocional y genera identificación con el prospecto."},
            {"pregunta": "Para contar historias efectivas en ventas es importante:",
             "opciones": ["Solo la autenticidad y los detalles", "Solo transmitir emociones", "Solo conocer al prospecto para que se identifique", "Autenticidad, transmitir emociones Y conocer al prospecto (todas)"],
             "correcta": 3, "explicacion": "Los tres elementos se potencian mutuamente. Sin autenticidad, no hay credibilidad. Sin emoción, no hay impacto. Sin conocer al lead, no hay identificación."},
            {"pregunta": "Para el cerebro humano, ¿qué es más motivador?",
             "opciones": ["Lograr un beneficio nuevo", "Evitar una pérdida que ya tiene", "Ambos son exactamente iguales", "Depende exclusivamente del prospecto"],
             "correcta": 1, "explicacion": "Principio de aversión a la pérdida: el cerebro procesa una pérdida con el doble de intensidad que una ganancia equivalente."},
            {"pregunta": "El sesgo de CONFIRMACIÓN sirve para:",
             "opciones": ["Detectar creencias y paradigmas del prospecto para presentar información que las respalde", "Evitar que el prospecto dude de tu propuesta", "Justificar el precio con datos técnicos", "Crear urgencia artificial en el cierre"],
             "correcta": 0, "explicacion": "El sesgo de confirmación: la mente busca coherencia con lo que ya cree. Si encontrás esas creencias, podés alinear tu mensaje con ellas."},
            {"pregunta": "Pedir un favor u opinión al prospecto es una técnica de venta porque:",
             "opciones": ["A todos nos gusta sentirnos importantes y valorados", "Hace al prospecto más vulnerable emocionalmente", "No es necesario, las personas siempre se sienten importantes", "Es una forma de manipulación encubierta"],
             "correcta": 0, "explicacion": "Efecto Ben Franklin: cuando alguien nos hace un favor, inconscientemente refuerza su percepción positiva sobre nosotros."},
            {"pregunta": "Al venderle a una MUJER, lo más relevante para la decisión suele ser:",
             "opciones": ["Dar muchos datos técnicos y estadísticas", "Cómo la va a hacer sentir el producto o servicio", "Solo el precio final comparado con la competencia", "El resultado numérico y medible"],
             "correcta": 1, "explicacion": "Las mujeres tienden a valorar más la experiencia emocional y el bienestar. El 'cómo me va a hacer sentir' es clave."},
            {"pregunta": "Al venderle a un HOMBRE, lo que más suele importar es:",
             "opciones": ["Las emociones que genera el producto", "La funcionalidad, el resultado final y los datos concretos", "El diseño y la estética del producto", "La opinión y validación de otros"],
             "correcta": 1, "explicacion": "Los hombres tienden a enfocarse en funcionalidad, resultados y hechos claros. La lógica y los números generan confianza."},
            {"pregunta": "¿Por qué el STORYTELLING es tan poderoso en ventas?",
             "opciones": ["Porque entretiene al prospecto durante la reunión", "Porque activa el cerebro emocional y genera identificación genuina", "Porque hace el pitch más largo y detallado", "Porque demuestra que el vendedor sabe mucho"],
             "correcta": 1, "explicacion": "Las historias generan oxitocina (conexión), dopamina (atención) y activan el cerebro como si la persona viviera la experiencia."},
            {"pregunta": "En ventas, el principio de RECIPROCIDAD dice:",
             "opciones": ["Si le das algo al prospecto, sentirá obligación genuina de devolverte algo", "El prospecto siempre devuelve exactamente lo que recibe", "La reciprocidad no aplica en ventas digitales", "Solo funciona con regalos físicos tangibles"],
             "correcta": 0, "explicacion": "Dar primero (valor, información, ayuda) activa el deseo natural de reciprocar. Es una de las herramientas más poderosas del vendedor."},
            {"pregunta": "La técnica de ANCLAJE consiste en:",
             "opciones": ["Fijar el precio alto primero y luego bajarlo para parecer flexible", "Asociar emocionalmente los problemas del cliente a consecuencias futuras concretas", "Repetir el nombre del cliente durante la conversación", "Hacer preguntas abiertas para conocer al lead"],
             "correcta": 1, "explicacion": "Anclar es conectar el dolor actual con lo que pasará si no se resuelve. Genera urgencia real basada en consecuencias, no en presión."},
            {"pregunta": "¿Qué activa más el cerebro del prospecto para que quiera actuar?",
             "opciones": ["Mostrar muchas características del producto", "Hacerle vivir emocionalmente el costo de su problema actual", "Dar un descuento especial solo por hoy", "Hablar de la competencia para generar comparación"],
             "correcta": 1, "explicacion": "Hacer que el prospecto sienta y visualice el costo real de su problema activa la necesidad de cambio desde adentro, sin presión externa."},
        ]
    },
    5: {
        "modulo": 5, "emoji": "🎯",
        "titulo": "Seguimientos Creativos",
        "aprobado": 9, "volver": 8,
        "preguntas": [
            {"pregunta": "¿Cuál es la diferencia principal entre 'perseguir' y 'hacer seguimiento'?",
             "opciones": ["No hay diferencia, son lo mismo", "El seguimiento aporta valor genuino; perseguir solo presiona para cerrar", "El seguimiento es simplemente menos frecuente", "Perseguir es más efectivo porque genera urgencia"],
             "correcta": 1, "explicacion": "Perseguir busca que el lead decida YA. El seguimiento busca mantener la relación aportando valor hasta que el lead esté listo."},
            {"pregunta": "¿Qué tipo de seguimiento habla de la PERSONA y su mundo, sin mencionar el producto?",
             "opciones": ["Seguimiento de Venta", "Seguimiento de Valor", "Seguimiento de Cierre", "Seguimiento Cruzado"],
             "correcta": 1, "explicacion": "El seguimiento de Valor no habla del producto. Habla del lead: su industria, sus intereses, algo útil para su vida. Genera confianza sin presión."},
            {"pregunta": "¿Qué tipo de seguimiento lo realiza una TERCERA PERSONA?",
             "opciones": ["Seguimiento de Valor", "Seguimiento de Venta", "Seguimiento de Cierre", "Seguimiento Cruzado"],
             "correcta": 3, "explicacion": "El Cruzado lo hace alguien de tu entorno (otro cliente, colega) que recomienda o valida. Tiene más credibilidad porque viene de un par."},
            {"pregunta": "El seguimiento de CIERRE se usa cuando:",
             "opciones": ["El prospecto todavía no nos conoce bien", "Ya está interesado, no necesitamos venderle más, solo facilitar la decisión", "Recién establecemos el primer contacto", "Otro vendedor lo contacta para recomendarnos"],
             "correcta": 1, "explicacion": "El Cierre aplica cuando el lead ya quiere comprar pero algo (tiempo, dinero, pareja) lo frena. Tu rol es eliminar ese freno puntual."},
            {"pregunta": "El seguimiento de VENTA busca principalmente:",
             "opciones": ["Solo dar información sobre el producto", "Despertar o reactivar el interés del prospecto sobre lo que ofrecés", "Que una tercera persona lo recomiende", "Cerrar sin más contacto directo"],
             "correcta": 1, "explicacion": "El seguimiento de Venta reactiva el interés cuando el lead se enfrió. Usa casos de éxito, demostraciones o novedades para generar deseo."},
            {"pregunta": "¿Cuál es la MEJOR estrategia de seguimiento?",
             "opciones": ["Solo usar seguimiento de valor siempre", "Solo usar seguimiento de venta para no perder oportunidades", "Combinar los 4 tipos según el momento del lead", "Solo el seguimiento cruzado porque viene de terceros"],
             "correcta": 2, "explicacion": "Combinar los 4 tipos es la estrategia ideal. Cada tipo tiene su momento y su propósito. La mezcla inteligente es lo que convierte."},
            {"pregunta": "Si un prospecto deja de responder después de mostrar interés, el primer paso es:",
             "opciones": ["Dejar de contactarlo definitivamente", "Enviar un seguimiento de valor personalizado y no invasivo", "Bajar el precio para ver si reacciona", "Llamar todos los días hasta que responda"],
             "correcta": 1, "explicacion": "Un seguimiento de valor reactiva sin presión. Le recordás que existís aportando algo útil para él, sin pedirle nada a cambio."},
            {"pregunta": "¿Por qué la mayoría de las ventas ocurren DESPUÉS del primer contacto?",
             "opciones": ["Porque los leads son indecisivos por naturaleza", "Porque la decisión de compra requiere tiempo y múltiples puntos de contacto de valor", "Porque los vendedores no son lo suficientemente insistentes", "Porque el precio siempre necesita negociación"],
             "correcta": 1, "explicacion": "Los estudios muestran que el 80% de las ventas ocurren entre el 5° y el 12° contacto. La mayoría de los vendedores se rinden en el 2°."},
            {"pregunta": "¿Cada cuánto tiempo es ideal hacer seguimiento a un prospecto TIBIO?",
             "opciones": ["Todos los días para no perder presencia", "Aproximadamente cada 5-10 días con valor genuino", "Una vez al mes para no molestar", "Solo cuando el prospecto vuelva a escribir"],
             "correcta": 1, "explicacion": "La frecuencia ideal mantiene presencia sin agotar. Muy frecuente = invasivo. Muy esporádico = se olvida de vos. Cada 5-10 días con valor es el punto dulce."},
            {"pregunta": "Un seguimiento de valor efectivo debe:",
             "opciones": ["Mencionar siempre el precio al final del mensaje", "Hablar solo del producto para refrescar lo que ofrecés", "Aportar algo útil para el prospecto antes (o sin) hablar del producto", "Ser muy largo y detallado para demostrar esfuerzo"],
             "correcta": 2, "explicacion": "El valor viene primero. Si tu mensaje solo habla de tu producto, es publicidad, no seguimiento. Aportá algo que lo ayude en su vida o negocio."},
            {"pregunta": "El seguimiento CRUZADO es más efectivo cuando:",
             "opciones": ["El vendedor no tiene tiempo de hacer seguimiento directo", "La tercera persona tiene credibilidad y conoce al prospecto", "El precio es muy alto y necesitás más argumentos", "El prospecto no tiene ningún interés en el producto"],
             "correcta": 1, "explicacion": "La credibilidad del cruce viene de la relación previa. Un cliente satisfecho que recomienda tiene 10x más impacto que el vendedor hablando de sí mismo."},
            {"pregunta": "¿Por qué hacer seguimiento es una habilidad CRÍTICA para un vendedor VH?",
             "opciones": ["Porque permite contactar más leads por día", "Porque la mayoría de las personas necesita tiempo y varios puntos de contacto para confiar y decidir", "Porque reduce el tiempo de la reunión principal", "Porque es obligatorio según las reglas del programa"],
             "correcta": 1, "explicacion": "La confianza se construye en el tiempo. El seguimiento bien hecho convierte el 'tal vez más adelante' en 'sí, quiero avanzar'."},
        ]
    },
}


@app.route("/formacion/evaluacion/<int:modulo>")
def evaluacion_modulo(modulo: int):
    redir = _require_vendor()
    if redir: return redir
    quiz = _QUIZZES.get(modulo)
    if not quiz:
        return redirect(url_for("formacion_vh"))
    return render_template("evaluacion.html", quiz=quiz)
